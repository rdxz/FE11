...
留言信息
  ...
  <ul class="comment">
    ...
    <?php
      require_once('db.php');
      $findComment = "select * from comment";

      $result = $dbh->query($findComment);
      // var_dump($result);
      // die;
      ...
      ?>
        <li class="comment-list">
          ...
          <span>
            <?php 
              $time = date('Y-m-d H:i:s', (int)$value['time']);
              echo $time;
             ?>
          </span>
        </li>
    ...
    <!-- <li class="comment-list">
      <h3>username</h3>
      <p>这是评论这是评论这是评论这是评论这是评论这是评论这是评论这是评论是评论这是评论这是评论这是评论这是评论这是评论这是评论</p>
      <span>评论时间</span>
    </li> -->
  </ul>
</body>
